...
> source: https://gitlab.com/Mr_Goldberg/goldberg_emulator/-/wikis/Compatibility-list
...
Conan Exiles (Make a single player game and have others connect with lobby_connect.exe or host a dedicated server and connect to it in the server browser)
Pixel Privateers
Ancestors Legacy
...
Payday 2
Senran Kagura Estival Versus (If the game crashes when starting a multiplayer game then your steam id was generated with an old version of the emu and you need to regenerate it)
Strange Brigade
Ace Combat 7
Shogun 2 Total War (Install the Prophet (Reloaded) crack first then rename its steam_api.dll to cracksteam_api.dll before installing my emu)

> source: https://www.reddit.com/r/GoldbergEmu/comments/bg7f3e/please_sticky_list_of_confirmed_workingnonworking/
...
> source: https://www.reddit.com/r/GoldbergEmu/comments/bnug6u/goldberg_emulator_is_godsend_for_local_coop/
